...
<script>
    $(document).ready(function(){
        $('.add-to-cart').click(function(){
            ...
            $.ajax({
                url: '<?php echo e(route('add_cart_ajax')); ?>',
                method: 'POST',
                data:{
                    id_: product_id,
                    shop_id: shop_id,
                ...
                success: function(data){
                    ...
                    if($status == true){
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                window.location.href = '<?php echo e(route('show_cart_ajax')); ?>';
                            } 
...
</script><?php /**PATH D:\Ecommerce\resources\views/detail_js.blade.php ENDPATH**/ ?>