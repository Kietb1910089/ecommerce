    ...
    <main >
        ...
        <?php if(Session::get('count_cart') != 0): ?>
            <div class="page-cart">
                ...
                <form method="GET" action="<?php echo e(route('checkout')); ?>" class="cart-form" id="cart-form">
                    
                <div class="cart-table">
                    <div class="cart-table-left" id="cart-table-left">
                        <?php $__currentLoopData = $shop_sum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop_cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="cart-table-left-all">
                            <div class="cart-table-left-shop">
                                <div class="cart-table-left-shop-info">
                                    <div class="cart-table-left-shop-icon">
                                        <div class="cart-table-left-shop-img">
                                            <a href="<?php echo e(route('view_shop',$shop_cart -> shop_id)); ?>">
                                                <img id="cart-table-left-shop-img" src="<?php echo e(asset('storage/'.$shop_cart->product_cart[0]->shopImg )); ?>" alt="">
                                            </a>    
                                        </div>
                                        <div class="cart-table-left-shop-name">
                                            <a  id="cart-table-left-shop-name" href="<?php echo e(route('view_shop',$shop_cart -> shop_id)); ?>">
                                                <span ><?php echo e($shop_cart->product_cart[0]->shopname); ?></span>
                                            </a>
                                        </div>   
                                    </div>
                                    <div class="cart-table-left-shop-choice">
                                        <input type="radio" name="choice-shop" class="choose_shop_cart" id="shop_id_<?php echo e($shop_cart -> shop_id); ?>" value="<?php echo e($shop_cart->shop_id); ?>" data-shop_id="<?php echo e($shop_cart->shop_id); ?>" style="width:16px; height:16px;" required>
                                ...
                                <?php $__currentLoopData = $shop_cart->product_cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="hidden" id="cart_id_<?php echo e($product -> id); ?>" value="<?php echo e($product->id); ?>">
                                    ...
                                    <div class="table-left-product">
                                        ...
                                        <div class="table-left-product-info colum-5">
                                            <div class="table-left-product-img">
                                                <a href="<?php echo e(route('detail_product',$product -> product_id)); ?>">
                                                    <img id="table-left-product-img" src="<?php echo e(asset('storage/'.$product->product_image)); ?>" alt="">
                                                </a>
                                            </div>
                                            <div class="table-left-product-name">
                                                <a id="table-left-product-name" href="<?php echo e(route('detail_product',$product -> product_id)); ?>">
                                                    <span><?php echo e($product->productName); ?></span>
                                                </a>
                                                <div class="table-left-product-type">
                                                    <?php if($product->combination == ""): ?>
                                                        <span id="table-left-product-type">Mặc định</span>
                                                    <?php else: ?>
                                                    Phân Loại: <span id="table-left-product-type"><?php echo e($product->combination); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="table-left-product-price colum-2">
                                            <span id="table-left-product-price"><?php echo e($product->product_price); ?></span> 
                                        </div>
                                        ...
                                        <form method="POST" class="cart-form" >
                                            ...
                                            <div class="Z+JGL3 shopee-input-quantity">
                                                <!-- Giam so luong -->
                                                <span id="minus_cart_<?php echo e($product -> id); ?>" class="EquXA8 minus_cart" data-avai_stock="<?php echo e($product->avaiable_stock); ?>"  data-id_cart="<?php echo e($product->id); ?>">
                                                    <svg enable-background="new 0 0 10 10" viewBox="0 0 10 10" x="0" y="0" class="shopee-svg-icon">
                                                        <polygon points="4.5 4.5 3.5 4.5 0 4.5 0 5.5 3.5 5.5 4.5 5.5 10 5.5 10 4.5"></polygon>
                                                    </svg>
                                                </span>

                                                <input id="number_cart_<?php echo e($product -> id); ?>" type="number" data-id_cart="<?php echo e($product->id); ?>" data-avai_stock="<?php echo e($product->avaiable_stock); ?>" class="EquXA8 Wrmraq quantity367 number_cart"  aria-valuenow="1" value="<?php echo e($product->quantity); ?>" required >
                                                <!-- Tang so luong -->
                                                <span id="plus_cart_<?php echo e($product -> id); ?>" class="EquXA8 plus_cart" data-avai_stock="<?php echo e($product->avaiable_stock); ?>"  data-id_cart="<?php echo e($product->id); ?>">
                                        ...
                                        <div class="table-left-product-tool colum-1">
                                            ...
                                            <span  class="table-left-product-tools delete_cart"  data-id_cart="<?php echo e($product->id); ?>">
...
<?php echo $__env->make('user.ajax_cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html>



<?php /**PATH D:\Ecommerce\resources\views/user/cart.blade.php ENDPATH**/ ?>