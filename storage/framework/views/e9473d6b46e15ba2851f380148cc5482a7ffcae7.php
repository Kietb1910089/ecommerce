            ...
            <div class="menu-index">
                <div class="body-index-menu">
                    ...
                    <div class="body-index-menu-center">
                        ...
                        <a href="<?php echo e(route('category_products', $cate -> categoryName)); ?>" class="body-index-menu-link ">
                            <div class="body-index-menu-product">
                                <div class="body-index-menu-product-img">
                                    <img src="<?php echo e(asset('storage/'.$cate->categoryIcon)); ?>" alt="" height="83px" width="88px">
                                </div>
                                <div class="body-index-menu-product-category">
                                    <?php echo e($cate->categoryName); ?>
...
<?php /**PATH D:\Ecommerce\resources\views/index.blade.php ENDPATH**/ ?>