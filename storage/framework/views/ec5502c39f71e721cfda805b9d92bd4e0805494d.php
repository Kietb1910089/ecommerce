                                                    ...
                                                    <div class="flex items-center bR6mEk">
                                                        <?php if(($combination_string[0]->combination_string)==''): ?>
                                                            <?php $__currentLoopData = $combination_string; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <input hidden checked type="radio" data-avai_stock="<?php echo e($combination -> avaiable_stock); ?>"  id="<?php echo e($combination->combination_string); ?>" value="<?php echo e($combination->combination_string); ?>" name="combination" class="choose_variation" >
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php else: ?>
                                                            <?php $__currentLoopData = $combination_string; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <input type="radio" data-avai_stock="<?php echo e($combination -> avaiable_stock); ?>"  id="<?php echo e($combination->combination_string); ?>" value="<?php echo e($combination->combination_string); ?>" name="combination" class="choose_variation" required>
