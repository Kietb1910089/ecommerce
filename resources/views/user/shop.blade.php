                        ...
                        <div class="section-seller-overview-horizontal__leading">
                            ...
                            <div class="section-seller-overview-horizontal__leading-content">
                                <div class="section-seller-overview-horizontal__seller-portrait -Pp4Kh">
                                    <a class="section-seller-overview-horizontal__seller-portrait-link" href="{{route('view_shop', $shop_info ->id)}}">
                                        <div class="shopee-avatar _3jLQRv">
                                            ...
                                            <img class="shopee-avatar__img" src="{{asset('storage/'.$shop_info -> shopImg)}}">
                                        </div>
                                        
                                    </a>
                                    <div class="section-seller-overview-horizontal__portrait-info">
                                        <h1 class="section-seller-overview-horizontal__portrait-name">{{$shop_info->shopname }}</h1>
                        ...
                        <div class="section-seller-overview-horizontal__seller-info-list">
                            <div class="section-seller-overview__item section-seller-overview__item--clickable">
                                ...
                                <div class="section-seller-overview__item-text">
                                    ...
                                    <div class="section-seller-overview__item-text-value">{{$product_count}}</div>
                                </div>
                            </div>
                            ...
                            <div class="section-seller-overview__item">
                                ...
                                <div class="section-seller-overview__item-text">
                                    ...
                                    <div class="section-seller-overview__item-text-value">{{$created_at}} ngày trước</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="shop-collection-view">
                        <div class="shopee-header-section--simple">
                            ...
                            <div class="shop-row-content">
                                @foreach($product_top_sale as $product)
                        ...
                        <div class="body-category-item">
                            <div class="shopee-sort-bar">
                                ...
                                <div class="shopee-sort-by-options" >
                                    <input class="choose_arrange" id="popular" checked  type="radio" name="choose_arrange" data-shop-id="{{$shop_info->id }}" data-choose_id="popular">
                                    <label class=" shopee-sort-by-options__option "  for="popular"> Phổ Biến</label> 
                                    
                                    <input class="choose_arrange" id="newest"  type="radio" name="choose_arrange" data-shop-id="{{$shop_info->id }}" data-choose_id="newest">
                                    <label class=" shopee-sort-by-options__option "  for="newest"> Mới nhất</label>

                                    <input class="choose_arrange" id="best_sell"  type="radio" name="choose_arrange" data-shop-id="{{$shop_info->id }}" data-choose_id="best_sell">
                                    <label class="shopee-sort-by-options__option "  for="best_sell"> Bán Chạy</label>
                                    
                                    <input class="choose_arrange" id="high_low"  type="radio" name="choose_arrange" data-shop-id="{{$shop_info->id }}" data-choose_id="high_low">
                                    <label class="shopee-sort-by-options__option "  for="high_low"> Giá: Cao đến thấp</label>
                                    
                                    <input class="choose_arrange" id="low_high"  type="radio" name="choose_arrange" data-shop-id="{{$shop_info->id }}" data-choose_id="low_high">
