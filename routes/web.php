...
Route::group([
    'middleware' => CheckingShopLogin::class],function(){
        ...
        Route::get('/show_chat_shop/{user_id}',[ChatController::class, 'show_chat_shop'])-> name('show_chat_shop');
...
Route::group([
    'middleware' => CheckingUserLogin::class],function(){
        ...
        Route::get('/user_purchase',[CheckoutController::class, 'user_purchase'])-> name('user_purchase');
        //Trang tin nhắn
        Route::get('/show_chat/{shop_id}',[ChatController::class, 'show_chat'])-> name('show_chat');
